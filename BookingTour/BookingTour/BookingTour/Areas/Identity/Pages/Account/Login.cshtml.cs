...
namespace BookingTour.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null && user.LockoutEnabled)
                {
                    ...
                    TempData["LockoutMessage"] = "Tài khoản của bạn đã bị khóa. Vui lòng liên hệ với quản trị viên.";
                    return Page();
                }
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null)
        {
            ...
            // Sử dụng info.LoginProvider và info.ProviderKey
            ...
            else
            {
                ...
                {
                    await _userManager.AddToRoleAsync(user, "User"); // Thêm vai trò mặc định cho người dùng
